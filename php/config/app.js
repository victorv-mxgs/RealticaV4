...
const CLIENT = 'AR1TUItD3m_y5Ob04uyRtCSOM8YZjyFKBSJZcJC2xkTysESUgKYiZEWcgHqSZ_2qoiuHwVgQtjN59WqE';
const SECRET = 'ENJzrlpwjR1HmoOJa5OUS7NdWcpgpErA0PiBJ3e18ksUxbaeNmmmrwDHGpGrEKcLhqnsNk7tGdaxjLVx';
...
const createProduct = (req, res) => {
    const product = {
        name: 'Subscripcion',
        description: "Subscripcion  mensualmente",
        type: 'SERVICE',
        category: 'SOFTWARE',
