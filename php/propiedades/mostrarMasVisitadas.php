...
$data = file_get_contents("php://input");
 ...
 $consulta = $pdo->prepare("SELECT pro.cTituloPropiedad,pro.nVisitas, pro.cExtra, pro.cStatus, pro.dConstruccion, pro.nPago, pro.nPropiedadId,  me.cNombre from propiedad pro inner join media me on me.nPropiedadId = pro.nPropiedadId
 ORDER BY nVisitas DESC limit 6 ");
 $consulta->execute();
